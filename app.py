...
with st.sidebar:
    ...
    if st.button("🔄 Refresh data", use_container_width=True):
        refresh()
    st.caption("Data synced from Google Sheets · Auto-saves on every change")
...
try:
    ...
    st.info("Check your Google Sheets credentials in `.streamlit/secrets.toml` — see SETUP.md")
    st.stop()
